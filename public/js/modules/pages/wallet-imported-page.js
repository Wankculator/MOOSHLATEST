// MOOSH WALLET - Wallet Imported Page Module
// Confirmation page after successful wallet import
...
(function(window) {
    ...
    window.WalletImportedPage = WalletImportedPage;
    
    // Also attach to MOOSHWalletApp namespace if it exists
    if (window.MOOSHWalletApp) {
        window.MOOSHWalletApp.WalletImportedPage = WalletImportedPage;
    }
